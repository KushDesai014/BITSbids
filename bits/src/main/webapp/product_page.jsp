...
//List<Seller> seller= ob1.getSeller(); 
            ...
            <nav class="navbar navbar-expand-lg bg-primary navbar-dark px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                    	...
                    	<a href="mainpage.jsp" class="nav-item nav-link ">Add Product</a>
...
<div class="container mt-5 px-5">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src=<%=st[x].getPr_img1() %> width="650" height="500" class="d-block object-fit-cover" alt="...">
    </div>
    <div class="carousel-item">
      <img src=<%=st[x].getPr_img2() %> width="650" height="500" class="d-block object-fit-cover" alt="...">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
 	 ...
 	 <div class="col-md-7 px-4 ">
 			...
 			<p>Product Code: <%=st[x].getPr_id() %></p>
 			<p class="">Current Bid : 1000</p>
 			<p>Description : Description in database</p>
 			<label>Enter Your Bid : base price + </label>
 			<input type="number" value="1">
 			<button type="button" class="btn btn-primary col-md-7 mt-2">Place Bid</button>
 			<label class="mt-3 col-md-7">Chat with the Seller</label>
 			<textarea name="" id="" class="mt-2	col-md-7" cols="30" rows="6"></textarea>
 			<button type="button" class="btn btn-primary col-md-7">Send Message</button>
 	 </div>
 	</div>
</div>
